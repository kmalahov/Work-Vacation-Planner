...
namespace WF.coursework
{
    public partial class GanttChart : UserControl
    {
        ...
        private Pen lineColor = Pens.Black;        //че то на татарском
        ...
        private void DrawScrollBar(Graphics grfx)
        {
            ...
            if (scroll.Height == 0 || scroll.Width == 0) 
                return;
            ...
            if (mouseOverScrollBar == true)
                colorScroll = new LinearGradientBrush(scroll, Color.Black, Color.Gray, LinearGradientMode.Horizontal);
            else
